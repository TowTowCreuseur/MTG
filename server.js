...
// Serveur HTTP (requis par Render pour health checks)
const server = http.createServer((req, res) => { res.writeHead(200); res.end('MTG WebSocket server is running.'); });
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`[WS] Serveur WebSocket prêt sur le port ${PORT}`);
});
