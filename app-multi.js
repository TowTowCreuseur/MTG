  ...
  document.querySelector('#createSessionBtn')?.addEventListener('click', () => {
    ...
    dlg.innerHTML = `
      <div style="padding:24px 28px;text-align:center;">
        ...
        <div id="session-code-display" style="font-size:2.4rem;font-weight:900;letter-spacing:6px;color:#4f8cff;background:#0e1522;border-radius:10px;padding:14px 20px;border:1px solid #22314a;font-family:monospace;">${room}</div>
